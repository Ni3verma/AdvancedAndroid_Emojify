...
public class Emojifier {
    ...
    public static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap bitmapImage) {
        ...
        Bitmap resultBitmap = bitmapImage;
        ...
        if (faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); i++) {
                ...
                switch (emoji) {
                    ...
                    default:
                        emojiBitmap = null;
                        Toast.makeText(context, "No emoji could be matched", Toast.LENGTH_SHORT).show();
                }
